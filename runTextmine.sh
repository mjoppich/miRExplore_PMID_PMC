...
bash doTextmine.sh "/usr/bin/python3 $MIREXPLORE_PATH/textmining/textmineDocument.py --threads 40" "/mnt/raidtmp/joppich/pubmed_pmc/pmc/europepmc/" "./results.pmc.raw/" "./"
